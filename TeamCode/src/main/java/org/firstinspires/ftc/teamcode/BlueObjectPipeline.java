...
public class BlueObjectPipeline extends OpenCvPipeline {
     ...
     */
    public static Point REGION1_CENTER_ANCHOR_POINT = new Point(150,800);
    public static Point REGION2_CENTER_ANCHOR_POINT = new Point(620,600);
    public static Point REGION3_CENTER_ANCHOR_POINT = new Point(1100,800);
    ...
    private volatile BlueObjectPipeline.ElementPosition position = BlueObjectPipeline.ElementPosition.LEFT;
    ...
    public Mat processFrame(Mat input)
    {
        ...
        {
            position = BlueObjectPipeline.ElementPosition.LEFT; // Record our analysis
            Element_Position = 1;
        ...
        {
            position = BlueObjectPipeline.ElementPosition.CENTER; // Record our analysis
            Element_Position = 2;
            /*
        ...
        {
            position = BlueObjectPipeline.ElementPosition.RIGHT; // Record our analysis
            Element_Position = 3;
     ...
     */
    public BlueObjectPipeline.ElementPosition getAnalysis()
    {
        return position;
    }
